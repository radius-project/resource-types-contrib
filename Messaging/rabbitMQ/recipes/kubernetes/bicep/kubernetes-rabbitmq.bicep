...
output result object = {
  ...
  secrets: {
    // A RabbitMQ AMQP 0-9-1 URI (amqp://user:pass@host:5672) — the format RabbitMQ
    // clients expect, unlike the Service Bus `Endpoint=sb://...` string. Radius
    // materializes it into the managed Radius.Security/secrets resource; it is never
    // written onto the resource.
