...
locals {
  ...
  instance_class = var.instanceClass != "" ? var.instanceClass : local.instance_class_map[local.size_value]
...
module "db" {
  ...
  family               = "postgres${var.postgresqlVersion}"
  major_engine_version = var.postgresqlVersion
