...
- kind (string, optional): Logical secret kind. One of: generic, certificate-pem, certificate-pkcs12, basicAuthentication, awsIRSA, azureWorkloadIdentity, sshKey. Defaults to "generic".
